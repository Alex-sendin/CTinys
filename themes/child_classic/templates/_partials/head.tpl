 ...
 *}
{block name='cookie_declaration'}
  <script id="Cookiebot" src="https://consent.cookiebot.com/uc.js" data-cbid="98c4ec54-f25e-4779-9f6d-b2a8cf5ebaa1" data-blockingmode="auto" type="text/javascript"></script>
{/block}
{block name='google_metrics'}
  {literal}
    <!-- Google Tag Manager -->
    ...
    })(window,document,'script','dataLayer','GTM-P34TR634');</script>
    <!-- End Google Tag Manager -->
     <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-YRSPCY125M"></script>
    <script>
