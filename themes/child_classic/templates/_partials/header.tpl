...
{block name='header_nav'}
  <div class="header-advisor">{l s="Obtén un 10% de descuento en tu primera compra" d="Shop.Theme.Global"} &nbsp <a href="">{l s='¡Quiero mi descuento!' d="Shop.Theme.Global"}</a></div>
