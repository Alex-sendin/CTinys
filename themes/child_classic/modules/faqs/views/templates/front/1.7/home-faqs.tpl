{if $faqs}
    <input type="hidden" class="basePath" name="basePath" value="{$basePath}">
    <section class="faqs-card-block gomakoil_faq_page ">
        <p class="h1 title_category_page">{l s='FAQs that can help you'  mod='faqs'}</p>
