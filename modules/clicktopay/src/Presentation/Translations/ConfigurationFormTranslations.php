...
class ConfigurationFormTranslations extends AbstractTranslations
{
    ...
    public function translations(): array
    {
        return $this->htmlDecode([
            ...
            'Configuration.Form.regenerateExpiredKeys' => $this->module->l('API keys expired, regenerate now', self::FILE_NAME),
            'Configuration.Form.apiKeysAreExpired' => $this->module->l('API keys have expired on', self::FILE_NAME),
            'Configuration.Form.seamlessGenerateExpiredFreshKeys' => $this->module->l('Generate fresh keys and update the configuration file to keep accepting Click to Pay seamlessly,', self::FILE_NAME),
        ]);
    }
}
