...
<div id="dcf-overlay" class="dcf-overlay">
                    ...
                    <div id="otp-form" class="form-step {if $clicktopay.isDarkTheme}dark{/if}">
                        <div class="otp-form-container {if $clicktopay.isDarkTheme}dark{/if} clicktopay-opc-otp"> 
                            <div id="mc_isv_otp_placeholder"></div>
                                <div class="c2p-otp-form-manual-card-button-section">
                                    <div class="id-lookup-line">
                                        <span class="id-lookup-line-text">{l s='OR' mod='clicktopay'}</span>
                                    </div>
                            
                                    <div class="c2p-ptb-4">
                                        <button class="id-lookup-manual-card-entry-button" type="button">
