...
<div class="card-list-main">
    ...
    <div class="card-list-title-wrapper" style="display: flex">
        <h4 class="card-list-title">{l s='Complete payment with' mod='clicktopay'}</h4>
    ...
    <div class="c2p-pt-6 card-list-not-you-button-container d-hidden">
        <button id="card-list-not-you-button" class="card-list-not-you-button" type="button"></button>
    </div>

    <div class="c2p-pt-4">
        <div id="card-list-dropdown" class="card-list-dropdown">
            <button id="card-list-dropdown-button" class="card-list-dropdown-button" type="button">
                ...
                <div class="card-list-dropdown-button-full-card d-hidden">
                    <img
                        class="card-list-dropdown-button-full-card-option-img"
                        src=""
            ...
            >
                ...
                >
                    <div class="card-list-dropdown-content-card-option-card">
                        <img
                            class="card-list-dropdown-content-card-option-img"
                            src=""
                            alt="{l s='Card' mod='clicktopay'}"
                        >
    ...
    {include file="./cvv_input_form.tpl" }
