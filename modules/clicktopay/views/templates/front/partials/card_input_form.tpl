...
<div class="card-input-main">
    ...
    <div id="card-input-access-your-cards-step">
        ...
        <div class="c2p-pt-4">
            <button
                type="button"
                id="card-input-access-your-cards-button"
                class="card-input-access-your-cards-button d-hidden"
            >
                <img
                    class="card-input-button-img"
                    src="{$clicktopay.icons.c2pIcon|escape:'htmlall':'UTF-8'}"
            ...
            <button
                type="button"
                id="card-input-access-your-saved-cards-button"
                class="card-input-access-your-cards-button d-hidden"
            >
                <img
                    class="card-input-button-img"
