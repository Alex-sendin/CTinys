...
<div id="mpm_faqs_form_container">
	 ...
	 <span class="title">{l s='Consulta'  mod='faqs'}</span>
    ...
    <section id="mpm_faqs_form_content">
        <div class="form-group" id="name_customer_form_group">
            ...
            <div class="input-group">
                ...
                <i class="mpm-faqs-error mpm-faqs-form-input-info-sign"></i>
            </div>
        </div>
                ...
                <div id="mpm_faqs_select_wrapper" class="form-control">
                    <select name="category_question">
                        ...
                        {foreach $faqCategories as $category}
                        	{assign var=splitName value="|"|explode:$category['name']}
                            <option size="1" value="{$category['id_gomakoil_faq_category']|escape:'htmlall':'UTF-8'}">{$splitName[0]|escape:'htmlall':'UTF-8'}</option>
                        {/foreach}
                    </select>
                </div>
            </div>
        ...
        <footer>
            <div class="form-group mpm-faqs-form-button-block" id="mpm_faqs_form_submit_button_block">
                <button type="submit" id="mpm_faqs_form_submit_button" class="btn btn-primary button mpm-faqs-form-button {if $consent_message}disabled-submit-btn{/if}" {if $consent_message}disabled{/if}>
                    <span>{l s='Enviar consulta'  mod='faqs'}</span>
