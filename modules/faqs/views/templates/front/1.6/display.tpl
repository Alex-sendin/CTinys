    ...
    <div id="center_column_fag" class="center_column_fag" >
        <div class="gomakoil_faq_page">
            ...
            {if $faq}
                ...
                {include file="{$path_tpl|escape:'htmlall':'UTF-8'}1.6/related-products.tpl" products = $faq['related_products'] }

                {include file="{$path_tpl|escape:'htmlall':'UTF-8'}1.6/faqs-from-same-category.tpl" faqs = $faq['faqs_same_category'] }
