...
class AdminFaqsPostController extends ModuleAdminController
{
  ...
  public function __construct()
  {
    ...
    $this->fields_list['id_gomakoil_faq_category'] = array(
      ...
      $this->fields_list['dislike'] = array(
          'title' => $this->l('Dislike'),
          'align' => 'center',
          'search' => false,
          'orderby' => false
      );
    ...
    $this->fields_form = array(
      ...
      'input' => array(
        ...
        array(
          ...
          'name' => 'question',
          'form_group_class'=> 'textarea_block question_field',
          'lang' => true,
          'required' => true,
          'autoload_rte' => true,
          'rows' => 10,
        ...
        array(
          ...
          'label' => $this->l('Answer:'),
          'name' => 'answer',
          'form_group_class'=> 'textarea_block answer_field',
          'autoload_rte' => true,
          'required' => true,
          'lang' => true,
          'rows' => 10,
        ...
        array(
          ...
          'name' => 'by_customer',
          'is_bool' => true,
          'form_group_class' => 'customer-question-btn-fg',
          'values' => array(
            array(
              'id' => 'display_on',
              'value' => 1,
