...
class Ps_Customtext2 extends Module implements WidgetInterface
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->trans('Custom text block 2', [], 'Modules.Customtext2.Admin');
        $this->description = $this->trans('Give your visitors extra information, display a customized block of content on your homepage.', [], 'Modules.Customtext2.Admin');
    ...
    protected function renderForm()
    {
        ...
        $fields_form = [
            'tinymce' => true,
            'legend' => [
                'title' => $this->trans('Custom text block', [], 'Modules.Customtext2.Admin'),
            ],
            'input' => [
                'id_info' => [
                    'type' => 'hidden',
                ...
                'content' => [
                    'type' => 'textarea',
                    'label' => $this->trans('Text block', [], 'Modules.Customtext2.Admin'),
                    'lang' => true,
                    'name' => 'text',
                    'cols' => 40,
                    'rows' => 10,
