...
class eco_fastlandingseco_fastlandingsModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
        ...
        if ($pageData) {
            ...
            $this->setTemplate('module:eco_fastlandings/views/templates/front/'.$pageData['template']);
        } 
        else {
