...
{block name='content'}
  <div id="tinys-landing-page" >
    ...
    <div class="{$page_data.class_name} primary-banner">
    </div>
    ...
    <section class="tinys-landing-content-image">
    </section>
    ...
    {if isset($page_data.fifth_content)}
      <section class="tinys-landing-fifth-content container">
        {$page_data.fifth_content nofilter}
      </section>
    {/if}
  </div>
  <section class="tinys-landing-content-advisor container">
    {hook h='displayTinysLandingAdvisor'}
  </section>
{/block}