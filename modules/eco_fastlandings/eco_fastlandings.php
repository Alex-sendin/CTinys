...
class Eco_fastlandings extends Module
{
    public function __construct()
    {
        $this->name = 'eco_fastlandings';
        ...
        $this->displayName = $this->l('Fast Landings');
    ...
    public function install()
    {
        return parent::install() &&
               ...
               $this->registerHook('displayTinysLandingAdvisor');
    }
