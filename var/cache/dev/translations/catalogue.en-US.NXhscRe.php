...
$catalogue = new MessageCatalogue('en-US', array (
  ...
  array (
    'Contact' => 'Contacto',
    'Close' => 'Cerrar',
    'Hecho con ❤️ desde |%Ecoitec%| - %year%' => 'Made with ❤️ from |%Ecoitec%| - %year%',
    'Obtén un 10% de descuento en tu primera compra' => 'Get 10% off your first purchase',
    'Los %1$sTinys%2$s son figuras articuladas que puedes coleccionar, usar como %3$sfidget%4$s para aliviar el estrés o como %5$smaterial sensorial para niños%6$s y adultos.' => '%1$sTinys%2$s are articulated figures that you can collect, use as %3$sfidget%4$s to relieve stress, or as %5$smaterial sensorial para niños%6$s and adults.',
    'Cada Tiny cuenta una historia y está creado con detalles precisos y materiales no tóxicos, pensados para estimular la creatividad, mejorar la concentración y ofrecer una experiencia divertida.' => 'Each Tiny tells a story and is crafted with precise details and non-toxic materials, designed to stimulate creativity, improve concentration, and provide a fun experience.',
    'Ver catálogo' => 'View catalog',
    'Tinys, Figuras articuladas' => 'Tinys, Articulated figures',
    'Únete al %1$smundo Tiny%2$s y empieza a construir tu propia colección con nuestros animales articulados' => 'Join the %1$sTiny World%2$s and start building your own collection with our articulated animals.',
...
According to the Rec.30;Art.7(1)(c)',
  ...
  array (
    ...
    'The theme can not be enabled cause of internal error: %s' => 'The theme can not be enabled cause of internal error: %s',
    ...
    'The theme %theme% cannot be deleted cause of internal error.' => 'The theme %theme% cannot be deleted cause of internal error.',
    ...
    'Internal error. Cannot access theme instance.' => 'Internal error. Cannot access theme instance.',
